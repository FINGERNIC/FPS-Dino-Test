...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/FPSDinosaurShootingGameSurvivalGame.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/FPSDinosaurShootingGameSurvivalGame.data',
                        frameworkUrl: 'Build/FPSDinosaurShootingGameSurvivalGame.framework.js',
                        codeUrl: 'Build/FPSDinosaurShootingGameSurvivalGame.wasm',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'Fingernic',
                        productName: 'FPS Dinosaur Shooting Game Survival Game',
                        productVersion: '0.1',
